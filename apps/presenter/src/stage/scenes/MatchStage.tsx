...
import type { GameRecord, TeamRef } from '@acm-uga/c4-contract';
import { BoardRenderer, cellCenter, computeGeometry, type Coord, type HandSide } from '@acm-uga/c4-board-ui';

...
function isWinningMove(board, c, r, player) {
...
function windowScore(cells, you, opponent) {
  let k = 0;
  let m = 0;
...
function negamax(board, player, you, ply) {
...
module.exports = { chooseMove, legalMoves, leafEval };
